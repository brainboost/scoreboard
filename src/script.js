...
$(document).ready(function () {
    ...
    $("#wrapScores").append('<div class="clearboth"></div>'), $(".resetScore0").click(function (e) {
        ...
        seg = settingsToUrl(), errorLog('<p>Your settings and current standings are encoded in the link below:</p><a href="https://scorecounter.com/' + seg + '">https://scorecounter.com/' + seg + "</a>");
